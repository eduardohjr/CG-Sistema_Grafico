...
class Window(QMainWindow):
    ...
    def createButtons(self):
        ...
        drawBezierSurface = QPushButton(self)
        drawBezierSurface.setText("Draw Bézier Surface")
        drawBezierSurface.setGeometry(320, 440, (BUTTON_WIDTH*2 + 20), BUTTON_HEIGHT)
        drawBezierSurface.clicked.connect(self.controller.drawBezierSurfaceEvent)
        
        drawBSplineSurface = QPushButton(self)
        drawBSplineSurface.setText("Draw BSpline Surface")
        drawBSplineSurface.setGeometry(320, 470, (BUTTON_WIDTH*2 + 20), BUTTON_HEIGHT)
        drawBSplineSurface.clicked.connect(self.controller.drawBSplieneSurfaceEvent)
